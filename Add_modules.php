...
<section class=' bg h-100'>
  ...
  <ul class='menu mt-5 '>
            ...
            <li><a class="dropdown-item text-light fw-bold active" href="#">Review Proposal</a></li>  
            <li><hr class="dropdown-divider text-light"></li>
            <li><a class="dropdown-item text-light fw-bold" href="#">Feasiblity Study</a></li>         
              ...
              <li><hr class="dropdown-divider text-light"></li>
              <li><a class="dropdown-item text-light fw-bold" href="#">Add Risk</a></li>         
              <li><hr class="dropdown-divider text-light"></li>
...
<form method="post" class="shadow mt-2 mx-5">
    <div class='row '>
        <div class="col-12 text-muted fw-bold fs-4 mt-2 text-center">Define Modules</div>
<div class='col-12 mt-2'>
           <div class='row justify-content-start'>
             <div class='col-md-4 '>
       <label class='form-label text-muted fw-bold'>Numbers of Modules?</label>
...
$("#keypress").keyup(function(){
              console.log("helo");
                ...
                for(let i=1;i<=count;i++){
                    ...
                    $(".languages").append("<div class='col-md-4 mt-2 pb-2 border mb-2 ' style='position:relative'>"+
                                            "<label class='form-label fw-bold text-muted'>Module"+i+"</label>"+
                                           "<input class='form-control' type='text' placeholder='enter module name'>"+
                                           "  <textarea class='form-control'  required style='resize:none;height:100px;' placeholder='write a description here!!!' name='problem' data-validate-field='description'></textarea>"+
