...
<form method="post" class="shadow mt-2 mx-5">
    <div class='row pb-4'>
        <div class="col-12 text-muted fw-bold fs-4 mt-2 text-center">Module cost</div>
<div class="col-md-6">
<input class='form-control mt-2' disabled value="module1"></input>
</div>
<div class="col-md-6 mt-2">
<input class='form-control'  placeholder="add cost"></input>
</div>
...
<div class="col-md-6 mt-2">
<input class='form-control' disabled value="module2"></input>
</div>
<div class="col-md-6 mt-2">
<input class='form-control'  placeholder="add cost"></input>
</div>
...
<div class="col-md-6 mt-2">
<input class='form-control' disabled value="module3"></input>
</div>
<div class="col-md-6 mt-2">
<input class='form-control'  placeholder="add cost"></input>
</div>
<div class='col-12 text-end'>
<button class="btn btn-outline-success mt-2  ">add cost</button>
</div>
</div><!--row-->
</form>
</div><!--bg-light-->
