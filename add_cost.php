        ...
        <li class="nav-item dropdown d-block d-md-none ">
          ...
          <!-- <li><a class="dropdown-item text-light fw-bold  " href="home.php">Assign projects</a></li>
            ...
            <li><a class="dropdown-item" href="road_map.php?id=<?php echo $id;?>">Road Map</a></li>         
              ...
              <li><hr class="dropdown-divider text-light"></li>
              <li><a class="dropdown-item active" href="add_cost.php?id=<?php echo $id;?>">Add Cost</a></li>         
              <li><hr class="dropdown-divider text-light"></li>
...
<div class='row bg-body p-3 h-auto '>
          ...
          <div class='col-12 text-muted  fw-bold mt-2 '>
           ...
           if(mysqli_num_rows($cost)>0){
             $price=0;
           while($fet=mysqli_fetch_assoc($cost)){
...
<div class="collapse p-0" id="collapseExample">
  ...
  <form  method="POST" class='js-form module' enctype="multipart/form-data" id="fileUploadForm">
      ...
      <div class='col-md-3'>
        ...
        <input class='form-control' placeholder='name' name='name' data-validate-field='subject'>

       </div>

       <div class='col-md-3 '>
        <label class='form-label text-muted fw-bold fs-5'>price</label>
        <input class='form-control' type='number' placeholder='price' name='price' data-validate-field='price'>
       ...
       <label class='form-label text-muted fw-bold fs-5'>desription</label>
        <input class='form-control'placeholder='description' name='description' data-validate-field='description'>
...
<?php }?>
  ...
  <option selected value=''>select</option>
  <?php while($fet=mysqli_fetch_assoc($module)){?>
...
<?php }?>
       ...
       <input type="hidden" class='form-label' name="p_id"  value="<?php echo $pro['p_id']; ?>">
        ...
        <button name='btn-submit' class='btn btn-outline-success mt-md-4'>create</button>
...
<table id="userTable" class=' table table-hover '>
  ...
  $cost=mysqli_query($conn,$query);
           ...
           while($fet=mysqli_fetch_assoc($cost)){?>
           <tr>
             <td><a href='c_detail.php?id=<?php echo $pro['p_id']?>&&mod_id=<?php echo $fet['mod_id'];?>' class='text-decoration-none text-dark'><?php echo $fet['c_id'];?></a></td>
