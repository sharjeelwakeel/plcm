...
<section class=' bg h-100'>
  ...
  <div class='col-md-3  d-none d-md-block  pb-3 bg-success rounded ' >
  ...
  <ul class='menu mt-5 '>
            ...
            <li><a class="dropdown-item text-light fw-bold active" href="detail_project.php">Review Proposal</a></li>  
            <li><hr class="dropdown-divider text-light"></li>
            <li><a class="dropdown-item text-light fw-bold" href="#">Feasiblity Study</a></li>         
              <li><hr class="dropdown-divider text-light"></li>
              <li><a class="dropdown-item text-light fw-bold" href="Add_modules.php">Add Modules</a></li>         
              <li><hr class="dropdown-divider text-light"></li>
              <li><a class="dropdown-item text-light fw-bold" href="add_cost.php">Add Cost</a></li>         
              <li><hr class="dropdown-divider text-light"></li>
              <li><a class="dropdown-item text-light fw-bold" href="add_risk.php">Add Risk</a></li>         
              <li><hr class="dropdown-divider text-light"></li>
              <li><a class="dropdown-item text-light fw-bold" href="#">Add Schedule</a></li>         
              <li><hr class="dropdown-divider text-light"></li>
...
<div class='row shadow bg-body p-3 h-auto'>
        <div class='col-12 text-muted h3 fw-bold'>
                Add Project Modules Risk
          </div>
          <h3 class='text-center text-success fw-bold'>Project Title</h3>
          <div class="accordion" id="accordionExample">
  <div class="accordion-item">
    <h2 class="accordion-header" id="headingOne">
      <button class="accordion-button h2 fw-bold text-success" type="button" data-bs-toggle="collapse" data-bs-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
        Problem Statment
      </button>
    </h2>
  ...
  <div class="accordion-item">
    <h2 class="accordion-header" id="headingTwo">
      <button class="accordion-button  collapsed h2 fw-bold text-success" type="button" data-bs-toggle="collapse" data-bs-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
       Project Description
      </button>
    </h2>
...
<form method="post" class="shadow mt-2 mx-5">
    <div class='row pb-4'>
        <div class="col-12 text-muted fw-bold fs-4 mt-2 text-center">Module Risk</div>
<div class="col-md-4">
<label class='form-label text-muted fw-bold'>Module</label>
<input class='form-control mt-2' disabled value="module1"></input>
</div>
<div class="col-md-4 mt-2">
<label class='form-label text-muted fw-bold'>Risk</label>
<input class='form-control'  placeholder="add risk"></input>
</div>
<div class='col-md-4'>
<label class='form-label text-muted fw-bold'>Risk Category</label>
             <select  class='form-select' required name='specilality' >
               <option value=''>select</option>
                 <option value='Mobile app Development'>High</option>
                 <option value='Web Development'>Low</option>
             </select>
...
<button class="btn btn-outline-success mt-2  ">add risk</button>
</div>
