...
<!--dhtmlx csss and script-->
    ...
    <style>
        ...
        <?php   $query="select * from permission_status where m_id=".$m_id." and p_id=11";

$configure=mysqli_query($conn,$query);
$cfg=mysqli_fetch_assoc($configure);
// echo $cfg['p_id'];
// exit;
if($cfg['p_id']==11 && $cfg['status']=="no"){
?>
        ...
        <?php   $query="select * from permission_status where m_id=".$m_id." and p_id=9";

$configure=mysqli_query($conn,$query);
$cfg=mysqli_fetch_assoc($configure);
// echo $cfg['p_id'];
// exit;
if($cfg['p_id']==9 && $cfg['status']=="no"){
?>
...
.gantt_grid_head_cell.gantt_grid_head_add{
  pointer-events: none;
        ...
        <?php   $query="select * from permission_status where m_id=".$m_id." and p_id=10";

$configure=mysqli_query($conn,$query);
$cfg=mysqli_fetch_assoc($configure);
// echo $cfg['p_id'];
// exit;
if($cfg['p_id']==10 && $cfg['status']=="no"){
?>
...
<section class=' bg '>
  ...
  <ul class='menu mt-5'>
            ...
            <li><a class="dropdown-item text-light fw-bold " href="road_map.php?id=<?php echo $id;?>">Road Map</a></li>         
              ...
              <li><hr class="dropdown-divider text-light"></li>
              <li><a class="dropdown-item text-light fw-bold active" href="add_schedule.php?id=<?php echo $id;?>">Add Schedule</a></li>         
              <li><hr class="dropdown-divider text-light"></li>
              <li><a class="dropdown-item text-light fw-bold " href="add_cost.php?id=<?php echo $id;?>">Add Cost</a></li>         
              <li><hr class="dropdown-divider text-light"></li>
              <li><a class="dropdown-item text-light fw-bold " href="members.php?id=<?php echo $id;?>">Members</a></li>         
