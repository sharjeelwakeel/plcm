...
<html lang="en">
  ...
  <li><a class="dropdown-item " href="detail_project.php?p_id=<?php echo $id;?>">project detail</a></li>
            ...
            <li><hr class="dropdown-divider"></li>
            <li><a class="dropdown-item active" href="backlog.php?p_id=<?php echo $id;?>">Backlog</a></li>
            <li><hr class="dropdown-divider"></li>
                    ...
                    <div class="accordion-item">
                      <h2 class="accordion-header" id="headingOne">
                        <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#collapse<?php echo$i; ?>" aria-expanded="true" aria-controls="collapseOne">
                         <div class='row'>
                             <div class='col-md-4'>
                                 <input type='text' disabled name='sub'  class='form-control' value="<?php echo $ver['name'];?>" data-id="<?php echo$ver['b_id'];?>">
                             </div>
                             <div class='col-md-4'>
                             <input  name='s_date2' disabled value="<?php echo date("Y-m-d ",strtotime($ver['s_date']));?>" class='form-control' data-id="<?php echo$ver['b_id'];?>" autocomplete='off' id="datepicker<?php echo++$var;?>">
      </div>

                             <div class='col-md-4'>
                             <input  name='e_date2'disabled value="<?php echo  date("Y-m-d ",strtotime($ver['e_date'])); ?>" class='form-control' data-id="<?php echo $ver['b_id'];?>" autocomplete='off' id="datepicker<?php echo++$var;?>">
      </div>
                         </div>
                        </button>
                      </h2>
