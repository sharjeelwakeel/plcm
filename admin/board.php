...
<html lang="en">
  ...
  <li><a class="dropdown-item " href="detail_project.php?p_id=<?php echo $id;?>">project detail</a></li>
            ...
            <li><hr class="dropdown-divider"></li>
                 <li><a class="dropdown-item active" href="board.php?p_id=<?php echo $id;?>">Board</a></li>
            <li><hr class="dropdown-divider"></li>
...
<div class='col-md-9 align-self-start bg-light'>
    ...
    <div class='col-12 text-muted h3 fw-bold'>
          ...
          <div class='col-12'>
              ...
              <div class='col-md-5 border p-0 m-1'>
                      <div class='bg'>
                          Complete
                      </div>
                      <div class='row m-1 ' >
                  ...
                  <div class='col-md-5 m-1 border p-0'>
                      <div class='bg'>
                          Scheduled
                      </div>
                      <div class='row m-1 ' >
