...
$m_id=$_REQUEST['id'];
$query="select * from permission,permission_status where m_id=".$m_id." and permission.p_id=permission_status.p_id";
//echo $query;
$custom=mysqli_query($conn,$query);
$status=NULL;
if(isset($_REQUEST['add'])){
    $arr=(isset($_REQUEST['check']))?$_REQUEST['check']:NULL;
    $str=NULL;
    if(!empty($_REQUEST['check'])){   
$str = implode (", ", $arr);

$query="update permission_status set status='yes' where m_id=".$m_id." and p_id in(".$str.")";
if(mysqli_query($conn,$query)){
    $status="success";
}
}
if(empty($arr)){
    $query="update permission_status set status='no' where m_id=".$m_id;  
}
else{
$query="update permission_status set status='no' where m_id=".$m_id." and p_id not in(".$str.")";
}
// echo $query;
if(mysqli_query($conn,$query)){
    $status="success";
...
<html lang="en">
  <head>
    ...
    <title>ConfigureMembers-plcm</title>
...
<div class='col-md-9 align-self-start bg-light'>
    <div class='col-12 pt-2 fw-bold h2 text-muted'>
        Configure
    </div>
...
<div class="accordion" id="accordionPanelsStayOpenExample">
  <div class="accordion-item">
    ...
    <div id="panelsStayOpen-collapseOne" class="accordion-collapse collapse show" aria-labelledby="panelsStayOpen-headingOne">
      ...
      <div class=" h5 text-muted fw-bold">
    Module
  </div>


    <div class="form-check">
        <?php $per=mysqli_fetch_assoc($custom);?>
  <input class="form-check-input" type="checkbox" value="<?php echo $per['p_id'];?>" <?php echo($per['p_id']==1 && $per['status']=="yes")?"checked":"";?> name='check[]' id="flexCheckDefault1">
...
<div class="form-check">
<?php $per=mysqli_fetch_assoc($custom);?>
  <input class="form-check-input" type="checkbox" value="<?php echo $per['p_id'];?>" <?php echo($per['p_id']==2 && $per['status']=="yes")?"checked":"";?> name='check[]' id="flexCheckDefault2">
...
<div class="form-check">
<?php $per=mysqli_fetch_assoc($custom);?>
  <input class="form-check-input" type="checkbox" value="<?php echo $per['p_id'];?>" <?php echo($per['p_id']==4 && $per['status']=="yes")?"checked":"";?> name='check[]' id="flexCheckDefault3">
...
<div class=" h5 text-muted fw-bold">
    ...
    <div class="form-check">
        <?php $per=mysqli_fetch_assoc($custom);?>
  <input class="form-check-input" type="checkbox" value="<?php echo $per['p_id'];?>" <?php echo($per['p_id']==6 && $per['status']=="yes")?"checked":"";?> name='check[]' id="flexCheckDefault4">
...
<div class="form-check">
<?php $per=mysqli_fetch_assoc($custom);?>
  <input class="form-check-input" type="checkbox" value="<?php echo $per['p_id'];?>" <?php echo($per['p_id']==7 && $per['status']=="yes")?"checked":"";?> name='check[]' id="flexCheckDefault5">
...
<div class="form-check">
<?php $per=mysqli_fetch_assoc($custom);?>
  <input class="form-check-input" type="checkbox" value="<?php echo $per['p_id'];?>" <?php echo($per['p_id']==8 && $per['status']=="yes")?"checked":"";?> name='check[]' id="flexCheckDefault6">
...
<div class=" h5 text-muted fw-bold">
    ...
    <div class="form-check">
        <?php $per=mysqli_fetch_assoc($custom);?>
  <input class="form-check-input" type="checkbox" value="<?php echo $per['p_id'];?>" <?php echo($per['p_id']==9 && $per['status']=="yes")?"checked":"";?> name='check[]' id="flexCheckDefault7">
...
<div class="form-check">
<?php $per=mysqli_fetch_assoc($custom);?>
  <input class="form-check-input" type="checkbox" value="<?php echo $per['p_id'];?>" <?php echo($per['p_id']==10 && $per['status']=="yes")?"checked":"";?> name='check[]' id="flexCheckDefault8">
...
<div class="form-check">
<?php $per=mysqli_fetch_assoc($custom);?>
  <input class="form-check-input" type="checkbox" value="<?php echo $per['p_id'];?>" <?php echo($per['p_id']==11 && $per['status']=="yes")?"checked":"";?> name='check[]' id="flexCheckDefault9">
...
<div class="accordion" id="accordionPanelsStayOpenExample">
  <div class="accordion-item">
    <h2 class="accordion-header" id="panelsStayOpen-headingOne">
      <button class="accordion-button" data-bs-target="#panelsStayOpen-collapseFourth"  type="button" data-bs-toggle="collapse" aria-expanded="true" aria-controls="panelsStayOpen-collapseOne">
        REQUIRE MANAGEMENT
      </button>
    </h2>

    <div id="panelsStayOpen-collapseFourth" class="accordion-collapse collapse show" aria-labelledby="panelsStayOpen-headingOne">
      <div class="accordion-body">
<div class=" h5 text-muted fw-bold">
    Require
</div>
    ...
    <div class="form-check">
        <?php $per=mysqli_fetch_assoc($custom);?>
  <input class="form-check-input" type="checkbox" value="<?php echo $per['p_id'];?>" <?php echo($per['p_id']==12 && $per['status']=="yes")?"checked":"";?> name='check[]' id="flexCheckDefault12">
...
<div class="form-check">
<?php $per=mysqli_fetch_assoc($custom);?>
  <input class="form-check-input" type="checkbox" value="<?php echo $per['p_id'];?>" <?php echo($per['p_id']==13 && $per['status']=="yes")?"checked":"";?> name='check[]' id="flexCheckDefault13">
...
<div class="form-check">
<?php $per=mysqli_fetch_assoc($custom);?>
  <input class="form-check-input" type="checkbox" value="<?php echo $per['p_id'];?>" <?php echo($per['p_id']==14 && $per['status']=="yes")?"checked":"";?> name='check[]' id="flexCheckDefault14">
...
<div class="accordion" id="accordionPanelsStayOpenExample">
  <div class="accordion-item">
    <h2 class="accordion-header" id="panelsStayOpen-headingOne">
      <button class="accordion-button" data-bs-target="#panelsStayOpen-collapseFifth"  type="button" data-bs-toggle="collapse" aria-expanded="true" aria-controls="panelsStayOpen-collapseOne">
        QUALITY MANAGEMENT
      </button>
    </h2>

    <div id="panelsStayOpen-collapseFifth" class="accordion-collapse collapse show" aria-labelledby="panelsStayOpen-headingOne">
      <div class="accordion-body">
<div class=" h5 text-muted fw-bold">
    Test
</div>
    ...
    <div class="form-check">
        <?php $per=mysqli_fetch_assoc($custom);?>
  <input class="form-check-input" type="checkbox" value="<?php echo $per['p_id'];?>" <?php echo($per['p_id']==15 && $per['status']=="yes")?"checked":"";?> name='check[]' id="flexCheckDefault15">
...
<div class="form-check">
<?php $per=mysqli_fetch_assoc($custom);?>
  <input class="form-check-input" type="checkbox" value="<?php echo $per['p_id'];?>" <?php echo($per['p_id']==16 && $per['status']=="yes")?"checked":"";?> name='check[]' id="flexCheckDefault16">
...
<div class="form-check">
<?php $per=mysqli_fetch_assoc($custom);?>
  <input class="form-check-input" type="checkbox" value="<?php echo $per['p_id'];?>" <?php echo($per['p_id']==17 && $per['status']=="yes")?"checked":"";?> name='check[]' id="flexCheckDefault17">
...
<div class="accordion" id="accordionPanelsStayOpenExample">
  <div class="accordion-item">
    <h2 class="accordion-header" id="panelsStayOpen-headingOne">
      <button class="accordion-button" data-bs-target="#panelsStayOpen-collapseSix"  type="button" data-bs-toggle="collapse" aria-expanded="true" aria-controls="panelsStayOpen-collapseOne">
        RISK MANAGEMENT
      </button>
    </h2>

    <div id="panelsStayOpen-collapseSix" class="accordion-collapse collapse show" aria-labelledby="panelsStayOpen-headingOne">
      <div class="accordion-body">
<div class=" h5 text-muted fw-bold">
    Defect
</div>
    ...
    <div class="form-check">
        <?php $per=mysqli_fetch_assoc($custom);?>
  <input class="form-check-input" type="checkbox" value="<?php echo $per['p_id'];?>" <?php echo($per['p_id']==18 && $per['status']=="yes")?"checked":"";?> name='check[]' id="flexCheckDefault18">
...
<div class="form-check">
<?php $per=mysqli_fetch_assoc($custom);?>
  <input class="form-check-input" type="checkbox" value="<?php echo $per['p_id'];?>" <?php echo($per['p_id']==19 && $per['status']=="yes")?"checked":"";?> name='check[]' id="flexCheckDefault19">
...
<div class="form-check">
<?php $per=mysqli_fetch_assoc($custom);?>
  <input class="form-check-input" type="checkbox" value="<?php echo $per['p_id'];?>" <?php echo($per['p_id']==20 && $per['status']=="yes")?"checked":"";?> name='check[]' id="flexCheckDefault20">
...
<div class='col-12 mt-2 text-end py-2'>
                         <button class='btn btn-outline-success ' name='add'>configure</button>
                      </div>
  ...
  <div class='text-center'>
    Member Configure Successfully    </div>
</div>
