...
$id=$_GET['p_id'];
$query="select * from projects,category where p_id=".$_GET['p_id']. " and p_category=c_id";
// echo $query;
$d_pro=mysqli_query($conn,$query);
...
<div class='col-md-9 align-self-start'>
    <div class='row'>
<?php if(mysqli_num_rows($d_pro)>0){ 
  while($dp=mysqli_fetch_assoc($d_pro)){
  ?>
    <div class='col-md-12 mt-2 mt-md-0 '>
        
    <div class="card text-dark bg-light mb-3" >
               <div class="card-header d-flex">Project id:<?php echo $dp['p_id']; ?>
  ...
  <ul class="dropdown-menu" aria-labelledby="dropdownMenu2">
    ...
    <li><button class="dropdown-item" type="button">Delete</button></li>
          ...
          <h5 class="card-title text-center"><?php echo$dp['p_title']; ?></h5>

          <h5 class="card-title h6 ">Problem Statement:</h5>
          <p class='text-body'>
  <?php 
...
echo $dp['p_problem'];
    ...
    <h5 class="card-title h6 ">Project Type:</h5>
          <p class='text-body'>
    <?php echo $dp['c_name']; ?>
  </p>

    
    <h5 class="card-title h6 ">Project Details:</h5>

    <?php 
  
    $str= base64_decode($dp['p_description']); 
    echo $str;
    ...
    ?> 
     ...
     <a href="<?php echo $dp['file_path'] ?>" class='link-primary'>download</a> 
     </div><!--card-body-->
        </div><!--card-->
