...
$query="update members set f_name='".$f_name."',l_name='".$l_name."',designation='".$desig."',speciality='".$spec."',password='".$pass."',img_path='".$file_path."' where m_id=".$_GET['id'];

}
else if($_FILES['file']['size']!=0)
{
  $query="update members set f_name='".$f_name."',l_name='".$l_name."',designation='".$desig."',speciality='".$spec."',img_path='".$file_path."' where m_id=".$_GET['id'];

}
else if(isset($_REQUEST['check'])){
  $query="update members set f_name='".$f_name."',l_name='".$l_name."',designation='".$desig."',speciality='".$spec."',password='".$pass."' where m_id=".$_GET['id'];

}
else{
  $query="update members set f_name='".$f_name."',l_name='".$l_name."',designation='".$desig."',speciality='".$spec."' where m_id=".$_GET['id'];
    ...
    <div class='row shadow bg-body p-3 '>
        <div class='col-12 text-muted h3 fw-bold'>
          ...
          <div class='col-md-6'>
              ...
              <input type='text' class='form-control' value='<?php if(isset($row['f_name']))echo $row['f_name'];?>'required  name='f_name' data-validate-field='title' placeholder='enter your first name'> 

          </div>
          <div class='col-md-6'>
          <label class='form-label text-muted fw-bold'>last name</label>
              <input type='text' class='form-control'value='<?php if(isset($row['l_name'])) echo $row['l_name'];?>' required  name='l_name' data-validate-field='title' placeholder='enter your last name'> 
          ...
          <label class='form-label text-muted fw-bold'>Designation</label>
             <select  class='form-select' required name='designation' data-validate-field='category'>
               <option value=''>select</option>
                 <option <?php  if($row['designation']=="BS"){ echo "selected";} ?> value='BS'>BS</option>
                 <option <?php  if($row['designation']=="MS"){ echo "selected";} ?> value='MS'>MS</option>
             </select>
           
             <label class='form-label text-muted fw-bold'>Specilality</label>
             <select  class='form-select' required name='specilality' >
               <option value=''>select</option>
                 <option value='Mobile app Development'  <?php  if($row['speciality']=="Mobile app Development"){ echo "selected";} ?>>Mobile app Development</option>
                 <option value='Web Development' <?php  if($row['speciality']=="Web Development"){ echo "selected";} ?>>Web development</option>
             </select>

             <div class='email_password'>
             <label class='form-label text-muted fw-bold'>email</label>
              <input type='text' class='form-control'value='<?php if(isset($row['email'])) echo $row['email'];?>' disabled  name='email' data-validate-field='title' placeholder='enter your last name'> 
              <label class='form-label text-muted fw-bold'>password</label>
              <input type='text' class='form-control'value='<?php if(isset($row['password']))echo $row['password'];?>' disabled  name='pass' data-validate-field='title' placeholder='enter your last name'> 
  ...
  <input class="form-check-input" type="checkbox" name='check' value="checked" id="flexCheckDefault">
           ...
           <label class='form-label ms-auto text-muted fw-bold lab1'>Upload image</label><br>
               <label class='form-label lab1' for='upload'>
                ...
                <img src='<?php echo $row['img_path']; ?>' class='img-thumbnail img_rem'  style='width:80%; height:400px'>
             ...
             <div class='row languages justify-content-start'>
                 <?php while( $fetch=mysqli_fetch_assoc($lang)){?>
                    ...
                    <div class='col-md-4 mt-2 ' style='position:relative'><select name='languages[]' class='form-select' required>
                                             <option value=''>select</option>
                                             <option <?php if($fetch['l_name']=="JAVA"){ echo "selected";}?> value='JAVA'>JAVA</option>
                                            <option <?php if($fetch['l_name']=="PHP"){ echo "selected";}?> value='PHP'>PHP</option>
                                             <option <?php if($fetch['l_name']=="KOTLIN"){ echo "selected";}?> value='KOTLIN'>KOTLIN</option></select>
