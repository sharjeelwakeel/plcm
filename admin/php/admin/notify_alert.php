...
<a href='".$date['link_page']."p_id=".$date['p_id']."&&n_id=".$date['n_id']."' class='text-decoration-none d-block'>
...
$array.= "<a href='".$row['link_page']."p_id=".$row['p_id']."&&n_id=".$row['n_id']."' class='text-decoration-none'>
