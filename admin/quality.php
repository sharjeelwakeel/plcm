...
<table id="userTable" class=' table table-hover '>
       ...
       <tbody>
          ...
          <tr>
            <td ><a href='test_detail.php?p_id=<?php echo $id;?>&&t_id=<?php echo $fet['t_id'];?>' class='text-decoration-none text-dark'><?php echo $fet['t_id'];?></a></td>
            <td><?php echo $fet['name'];?></td>
            <td><?php echo $fet['status'];?></td>
            <td><?php echo $fet['f_name'];?></td>
            <td><?php echo date("Y-m-d ",strtotime($fet['due']));;?></td>
            <td><a class="btn btn-success btn-sm" data-bs-toggle="tooltip" data-bs-html="true" title="<em >defects</em> "  href="defect.php?p_id=<?php echo $id."&& t_id=".$fet['t_id'];?>">
 <img src="web_material/defect.png" style="width:16px;height:16px">
</a></td>
          </tr>
