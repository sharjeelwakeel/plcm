...
<!--dhtmlx csss and script-->
  ...
  <li><a class="dropdown-item " href="detail_project.php?p_id=<?php echo $id;?>">project detail</a></li>
            ...
            <li><hr class="dropdown-divider"></li>
            <li><a class="dropdown-item active" href="schedule.php?p_id=<?php echo $id;?>">Schedule</a></li>
            <li><hr class="dropdown-divider"></li>
...
<div class='col-md-9 align-self-start bg-light p-0'>
    <div class='row p-0 m-0'>
    <div class='col-md-12 h-100  gant_chart  p-0 mx-0' style="overflow-x:auto">
                <!--for gant chart-->
...
gantt.load("php/admin/get_module.php?id=<?php echo $id;?>");
