...
$query="select status,e_id,m_id ,emails.description,emails.date as date from emails where   emails.crt_id=".$s_id." order by e_id desc";
//echo $query;
...
if(mysqli_num_rows($emails)>0){
  ...
  if($em['m_id']==14){
    ...
    $query="select * from members where m_id=".$em['m_id'];
    ...
    $user.="<tr class='bg-success border border-start-0 border-end-0 border-top-0 border-light get_mail' data-id='".$em['e_id']."' data-m_id='".$em['m_id']."' style='cursor:pointer'><td><div class='text-light fw-bold'>".$name."</div>
...
div.checklist li.checked:hover, div.checklist li.checked:hover label {
  ...
  <button class="navbar-toggler " type="button" data-bs-toggle="collapse" data-bs-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      ...
      <!--send-->
           <a type="button" class="btn  btn-outline-success fw-bold disabled mx-2" href="send_mail.php">
  Send
</a> 
                  <!--send end-->
...
<button type="button" class="btn  btn-outline-success fw-bold mx-2" data-bs-toggle="modal" data-bs-target="#exampleModal">
  Create Mail
               ...
               <!--Button trigger modal end-->
                      ...
                      <!--send-->
               <a type="button" class="btn  btn-outline-success fw-bold mx-2" href="inbox_mail.php">
  Inbox
</a> 
                  <!--send end-->
...
function fetch_chat_receiver_dp(){
  $.ajax({
  method:"POST",
  url:"php/admin/fetch_receiver.php",
  data:{
...
$.ajax({
  method:"POST",
  url:"php/admin/send_message.php",
  data:{
