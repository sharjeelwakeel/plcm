...
if(mysqli_num_rows($emails)>0){
  ...
  if($em['m_id']==14){
    ...
    $user.="<tr class=' fw-bold border border-start-0 border-end-0 border-top-0 border-dark get_mail' data-id='".$em['e_id']."' data-m_id='".$em['m_id']."' style='cursor:pointer;background-color:white!important'><td><a href='see_mail.php?e_id=".$em['e_id']."&&m_id=".$em['m_id']."' class='d-block text-decoration-none'><div class='text-dark fw-bold text-muted fw-bold '>".$name."</div></a></td>
  ...
  $user="<tr class=' border border-0'><td class='text-dark text-center ' colspan='5'>no mail</td></tr> ";
...
<section class=' bg h-100'>
  ...
  <li><a class="  btn btn-success  btn-outline-light " href="create_mail.php">Create</a></li>  
            ...
            <li><a class="dropdown-item text-light fw-bold " href="inbox_mail.php">Inbox</a></li>         
              <li><hr class="dropdown-divider text-light"></li>
              <li><a class="dropdown-item text-light fw-bold active " href="sent_mail.php">Sent</a></li>         
              <li><hr class="dropdown-divider text-light"></li>
