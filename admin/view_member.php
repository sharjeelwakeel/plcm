                ...
                <?php foreach($arr_users as $user) { ?>
                    <tr class="bg-lights position-relative">
                      ...
                      <td><?php echo $user['d_name']; ?></td>
                          ...
                          <button class="btn btn-success btn-sm delete" data-id="<?php echo $user['m_id'];?>" >delete</button>
                          <a class="btn btn-success btn-sm" href="custom_member.php?id=<?php echo $user['m_id'];?>">configure</a>
                                  </td>
