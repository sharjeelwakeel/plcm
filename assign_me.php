...
//echo $query;
  ...
  $query="select f_name,mod_id,subject,type,status,priority,module.date from module,members where p_id=".$pro['p_id']." and m_id=assign_id and m_id=".$m_id." order by mod_id desc";
// echo $query;
        ...
        <li class="nav-item dropdown d-block d-md-none ">
          ...
          <!-- <li><a class="dropdown-item text-light fw-bold  " href="home.php">Assign projects</a></li>
            ...
            <li><a class="dropdown-item" href="road_map.php?id=<?php echo $id;?>">Road Map</a></li>         
              ...
              <li><hr class="dropdown-divider text-light"></li>
              <li><a class="dropdown-item active " href="assign_me.php?id=<?php echo $id;?>">Assigned to me</a></li>         
              <li><hr class="dropdown-divider text-light"></li>
...
<section class=' bg h-100'>
  ...
  <ul class='menu mt-5'>
            ...
            <li><a class="dropdown-item text-light fw-bold " href="road_map.php?id=<?php echo $id;?>">Road Map</a></li>         
              ...
              <li><a class="dropdown-item text-light fw-bold " href="work_packages.php?id=<?php echo $id;?>">Work Package</a></li>         
              <li><hr class="dropdown-divider text-light"></li>
              <li><a class="dropdown-item text-light fw-bold active" href="assign_me.php?id=<?php echo $id;?>">Assigned to me</a></li>         
              <li><hr class="dropdown-divider text-light"></li>
