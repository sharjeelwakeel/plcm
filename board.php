...
if(isset($_REQUEST['id'])){
 ...
 $query="select * from projects where p_id=".$id;
  ...
  $query="select f_name,mod_id,subject,type,status,priority,module.date from module,members where p_id=".$pro['p_id']." and m_id=assign_id order by mod_id desc";
...
<section class=' bg h-100'>
  ...
  <ul class='menu mt-5'>
            ...
            <li><a class="dropdown-item text-light fw-bold " href="road_map.php?id=<?php echo $id;?>">Road Map</a></li>         
              ...
              <li><a class="dropdown-item text-light fw-bold " href="members.php?id=<?php echo $id;?>">Members</a></li>         
              <li><hr class="dropdown-divider text-light"></li>
              <li><a class="dropdown-item text-light fw-bold active" href="board.php?id=<?php echo $id;?>">Board</a></li>         
              <li><hr class="dropdown-divider text-light"></li>
              <li><a class="dropdown-item text-light fw-bold " href="backlog.php?id=<?php echo $id;?>">Backlog</a></li>         
              <li><hr class="dropdown-divider text-light"></li>
              <li><a class="dropdown-item text-light fw-bold " href="require.php?id=<?php echo $id;?>">Require</a></li>         
...
<div class='row bg-body p-3 h-auto '>
          ...
          <div class='col-12'>
              <div class='row justify-content-start align-items-start p-0 m-0'>
                
              <div class='col-md-5 m-1 border p-0 m- shadow-lg'>
                      <div class='bg'>
                          Complete
                      </div>
                      <div class='row m-1 ' >
                          <?php
                            $query="select f_name,mod_id,subject,type,status,priority,module.date from module,members where p_id=".$pro['p_id']." and status='close' and m_id=assign_id order by mod_id desc";

                            $fetch=mysqli_query($conn,$query);
                            if(mysqli_num_rows($fetch)>0){
                                while($get_mod=mysqli_fetch_assoc($fetch)){
                                    ?>
                                    <div class='col-md-5 border m-1 shadow-sm'>
                                        <div class='text-muted fw-bold fs-5'><?php echo$get_mod['subject'];?></div>
                                        <div class='mt-4 text-end text-success'>
                                           #<?php echo $get_mod['mod_id'];?> completed
                                        </div>
                                    </div>
                  ...
                  <div class='col-md-6 m-1 border p-0 shadow-lg'>
                      <div class='bg'>
                          Scheduled
                      </div>
                      <div class='row m-1 ' >
                          <?php
                            $query="select f_name,mod_id,subject,type,status,priority,module.date from module,members where p_id=".$pro['p_id']." and (status='schedule' or status='In progress') and m_id=assign_id order by mod_id desc";
                            ...
                            if(mysqli_num_rows($fetch)>0){
                                while($get_mod=mysqli_fetch_assoc($fetch)){
                                    ...
                                    <div class='col-md-5 border m-1'>
                                        <div class='text-muted fw-bold fs-5'><?php echo$get_mod['subject'];?></div>
                                        <div class='mt-4 text-end text-warning'>
                                           #<?php echo $get_mod['mod_id'];?> In progress
                                        </div>
                                    </div>
                  ...
                  <div class='col-md-5 m-1 border p-0 shadow-lg'>
                      <div class='bg'>
                          To be schedule
                      </div>
                      <div class='row m-1 ' >
                          <?php
                            $query="select f_name,mod_id,subject,type,status,priority,module.date from module,members where p_id=".$pro['p_id']." and (status='To be schedule' ) and m_id=assign_id order by mod_id desc";
                            ...
                            if(mysqli_num_rows($fetch)>0){
                                while($get_mod=mysqli_fetch_assoc($fetch)){
                                    ...
                                    <div class='col-md-5 border m-1'>
                                        <div class='text-muted fw-bold fs-5'><?php echo$get_mod['subject'];?></div>
                                        <div class='mt-4 text-end text-info'>
                                           #<?php echo $get_mod['mod_id'];?> To be schedule
                                        </div>
                                    </div>
                  ...
                  <div class='col-md-6 m-1 border p-0 shadow-lg'>
                      ...
                      <div class='row m-1 ' >
                          <?php
                            $query="select f_name,mod_id,subject,type,status,priority,module.date from module,members where p_id=".$pro['p_id']." and status='rejected' and m_id=assign_id order by mod_id desc";
                            ...
                            if(mysqli_num_rows($fetch)>0){
                                while($get_mod=mysqli_fetch_assoc($fetch)){
                                    ...
                                    <div class='col-md-5 border m-1'>
                                        <div class='text-muted fw-bold fs-5'><?php echo$get_mod['subject'];?></div>
                                        <div class='mt-4 text-end text-danger'>
                                           #<?php echo $get_mod['mod_id'];?> Rejected
                                        </div>
                                    </div>
