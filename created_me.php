...
//echo $query;
  ...
  $query="select f_name,mod_id,subject,type,status,priority,module.date,m_file_path from module,members where p_id=".$pro['p_id']." and m_id=assign_id and create_id=".$m_id." order by mod_id desc";
...
<table id="userTable" class=' table table-hover '>
        ...
        <tbody>
           ...
           <tr>
             ...
             <td>
             <?php   $query="select * from permission_status where m_id=".$m_id." and p_id=2";
...
// exit;
?>
                          <a class="btn btn-success btn-sm <?php echo($cfg['p_id']==2 && $cfg['status']=="no")?"disabled":"" ?>" data-bs-toggle="tooltip" data-bs-html="true" title="<em >update</em> " href="edit_module.php?id=<?php echo $id."&& mod_id=".$fet['mod_id'];?>"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pencil-square" viewBox="0 0 16 16">
  <path d="M15.502 1.94a.5.5 0 0 1 0 .706L14.459 3.69l-2-2L13.502.646a.5.5 0 0 1 .707 0l1.293 1.293zm-1.75 2.456-2-2L4.939 9.21a.5.5 0 0 0-.121.196l-.805 2.414a.25.25 0 0 0 .316.316l2.414-.805a.5.5 0 0 0 .196-.12l6.813-6.814z"/>
  <path fill-rule="evenodd" d="M1 13.5A1.5 1.5 0 0 0 2.5 15h11a1.5 1.5 0 0 0 1.5-1.5v-6a.5.5 0 0 0-1 0v6a.5.5 0 0 1-.5.5h-11a.5.5 0 0 1-.5-.5v-11a.5.5 0 0 1 .5-.5H9a.5.5 0 0 0 0-1H2.5A1.5 1.5 0 0 0 1 2.5v11z"/>
</svg></a>

<?php   $query="select * from permission_status where m_id=".$m_id." and p_id=4";
...
// exit;
?>
                          <button class="btn btn-success btn-sm delete <?php echo($cfg['p_id']==4 && $cfg['status']=="no")?"disabled":"" ?>" data-bs-toggle="tooltip" data-bs-html="true" title="<em>delete</em>" data-id="<?php echo $fet['mod_id'];?>" ><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-archive-fill" viewBox="0 0 16 16">
