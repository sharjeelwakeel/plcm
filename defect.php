...
//echo $query;
  ...
  $query="select * from defect where t_id=".$t_id;
...
<div class='row bg-body p-3 h-auto '>
          ...
          <div class='col-12'>
          <p class='text-end'>
          <?php   $query="select * from permission_status where m_id=".$m_id." and p_id=18";
...
// exit;
?>
  <a class="btn btn-success <?php echo($cfg['p_id']==18 && $cfg['status']=="no")?"disabled":"" ?>" data-bs-toggle="collapse" href="#collapseExample" role="button" aria-expanded="false" aria-controls="collapseExample">
...
<table id="userTable" class=' table table-hover '>
    ...
    <ul class="dropdown-menu px-2" aria-labelledby="dropdownMenu2" style="min-width:50px">
        <div class='text-end '>
...
// exit;
?>
    <button type="button" class="btn btn-success btn-sm update <?php echo($cfg['p_id']==19 && $cfg['status']=="no")?"disabled":"" ?>"  data-action="update" data-bs-toggle="modal" data-bs-target="#updatemodal" data-id="<?php echo$fet['d_id'];?>" data-description="<?php echo$fet['description'];?>"  data-status="<?php echo$fet['status'];?>" ><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pencil-square" viewBox="0 0 16 16" >
...
// exit;
?>  
<button class="btn btn-success btn-sm delete mt-1 <?php echo($cfg['p_id']==20 && $cfg['status']=="no")?"disabled":"" ?>" data-bs-toggle="tooltip" data-bs-html="true" title="<em>delete</em>" data-id="<?php echo$fet['d_id'];?>" ><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-archive-fill" viewBox="0 0 16 16">
...
<div class="modal-dialog bg-light">
    ...
    <form  method="POST" class='js-form-update' > 
      ...
      <div class='col-md-6'>
       ...
       <div class='col-md-6'>
        <label class='form-label text-start text-muted fw-bold fs-5'>Status</label>
        <select class="form-select text-muted" aria-label="Default select example" id='select' name='status' data-validate-field='status'>
  <option selected value=''>Select</option>
