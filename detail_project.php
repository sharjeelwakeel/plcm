      ...
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item dropdown d-block d-md-none ">
          ...
          <!-- <li><a class="dropdown-item text-light fw-bold  " href="home.php">Assign projects</a></li>
            ...
            <li><a class="dropdown-item text-light fw-bold active" href="detail_project.php?id=<?php echo $pro['p_id']?>">Review Proposal</a></li>  
            <li><hr class="dropdown-divider text-light"></li>
            <li><a class="dropdown-item " href="road_map.php?id=<?php echo $pro['p_id']?>">Road Map</a></li>         
              <li><hr class="dropdown-divider text-light"></li>
              <li><a class="dropdown-item " href="work_packages.php?id=<?php echo $pro['p_id']?>">Work Package</a></li>         
              <li><hr class="dropdown-divider text-light"></li>
              <li><a class="dropdown-item " href="assign_me.php?id=<?php echo $pro['p_id']?>">Assigned to me</a></li>         
              <li><hr class="dropdown-divider text-light"></li>
              <li><a class="dropdown-item " href="created_me.php?id=<?php echo $pro['p_id']?>">Created by me</a></li>         
              <li><hr class="dropdown-divider text-light"></li>
              <li><a class="dropdown-item " href="add_schedule.php?id=<?php echo $pro['p_id']?>">Add Schedule</a></li>         
              <li><hr class="dropdown-divider text-light"></li>
...
<section class=' bg h-100'>
  ...
  <ul class='menu mt-5'>
            ...
            <li><a class="dropdown-item text-light fw-bold active" href="detail_project.php?id=<?php echo $pro['p_id']?>">Review Proposal</a></li>  
            <li><hr class="dropdown-divider text-light"></li>
            <li><a class="dropdown-item text-light fw-bold" href="road_map.php?id=<?php echo $pro['p_id']?>">Road Map</a></li>         
              <li><hr class="dropdown-divider text-light"></li>
              <li><a class="dropdown-item text-light fw-bold" href="work_packages.php?id=<?php echo $pro['p_id']?>">Work Package</a></li>         
              <li><hr class="dropdown-divider text-light"></li>
              <li><a class="dropdown-item text-light fw-bold" href="assign_me.php?id=<?php echo $pro['p_id']?>">Assigned to me</a></li>         
              <li><hr class="dropdown-divider text-light"></li>
              <li><a class="dropdown-item text-light fw-bold" href="created_me.php?id=<?php echo $pro['p_id']?>">Created by me</a></li>         
              <li><hr class="dropdown-divider text-light"></li>
              <li><a class="dropdown-item text-light fw-bold" href="add_schedule.php?id=<?php echo $pro['p_id']?>">Add Schedule</a></li>         
              <li><hr class="dropdown-divider text-light"></li>
              <li><a class="dropdown-item text-light fw-bold " href="add_cost.php?id=<?php echo $id;?>">Add Cost</a></li>         
              <li><hr class="dropdown-divider text-light"></li>
...
<h5 class=' text-dark fw-bold'>Problem Description</h5>   
          <div class='text-dark ' style="text-align:justify">
          <?php  $str= base64_decode($pro['p_description']); 
    echo $str;
    ?>

</div>

<a href='<?php echo "admin/".$pro['file_path'] ?>' downlaod>downlaod proposal</a>
</div><!--bg-light-->
</div><!--col-md-9-->
