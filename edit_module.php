...
<div class='row bg-body p-3 h-auto '>
  ...
  <form  method="POST" class='js-form module' id='fileUploadForm'>
      ...
      <div class='col-md-4'>
        ...
        <input class='form-control'placeholder='subject' value="<?php echo isset($mod['subject'])? $mod['subject']:''?>" name='subject' data-validate-field='subject'>

       </div>

       <div class='col-md-4'>
        <label class='form-label text-muted fw-bold fs-5'>type</label>
        <select class="form-select text-muted" aria-label="Default select example" name='type' data-validate-field='type'>
  <option selected value=''>Select</option>
  <option <?php echo ($mod['type']=='Task')? "selected":''?> value="Task">Task</option>
  <option <?php echo ($mod['type']=='Milestone')? "selected":''?> value="Milestone">Milestone</option>
  <option <?php echo ($mod['type']=='Phase')? "selected":''?> value="Phase">Phase</option>
</select>
  ...
  <option selected value=''>Select</option>
  <option  <?php echo ($mod['status']=='Schedule')? "selected":''?> value="Schedule">Schedule</option>
  <option  <?php echo ($mod['status']=='To be schedule')? "selected":''?> value="To be schedule">To be schedule</option>
  <option <?php echo ($mod['status']=='In progress')? "selected":''?>  value="In progress">In progress</option>
  <option <?php echo ($mod['status']=='Closed')? "selected":''?> value="Closed">Closed</option>
  <option <?php echo ($mod['status']=='On hold')? "selected":''?> value="On hold">On hold</option>
  <option <?php echo ($mod['status']=='Rejected')? "selected":''?> value="Rejected">Rejected</option>
</select>
  ...
  <option <?php echo ($mod['assign_id']==$asgn['m_id'])? "selected":''?>  value="<?php echo $asgn['m_id']; ?>"><?php echo $asgn['f_name']; ?></option>
<?php }?>
       ...
       <div class='col-md-4'>
        <label class='form-label text-muted fw-bold fs-5'>Priority</label>
        <select class="form-select text-muted" aria-label="Default select example" name='priority' data-validate-field='priority'>
  <option selected value=''>Select</option>
  <option <?php echo ($mod['priority']=='Low')? "selected":''?> value="Low">Low</option>
  <option <?php echo ($mod['priority']=='Normal')? "selected":''?> value="Normal">Normal</option>
  <option <?php echo ($mod['priority']=='High')? "selected":''?> value="High">High</option>
  <option <?php echo ($mod['priority']=='Immediate')? "selected":''?> value="Immediate">Immediate</option>
  ...
  <path d="M7.646 1.146a.5.5 0 0 1 .708 0l3 3a.5.5 0 0 1-.708.708L8.5 2.707V11.5a.5.5 0 0 1-1 0V2.707L5.354 4.854a.5.5 0 1 1-.708-.708l3-3z"/>
     ...
     <input type="hidden" value="<?php echo $mod['mod_id'];?>" name="mod_id">
        ...
        <button name='module' class='btn btn-outline-success mt-md-4 py-2'>update</button>
