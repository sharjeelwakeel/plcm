...
//echo $query;
  ...
  $query="select * from module,schedule where mod_id=".$mod_id." and m_id=".$mod_id;
...
<div class='row bg-body p-3 h-auto '>
  ...
  <form  method="POST" class='js-form module'>
      ...
      <div class='col-md-4'>
        ...
        <input class='form-control'placeholder='subject' disabled value="<?php echo isset($mod['subject'])? $mod['subject']:''?>" name='subject' data-validate-field='subject'>

       </div>

       <div class='col-md-4'>
        <label class='form-label text-muted fw-bold fs-5'>type</label>
        <select class="form-select text-muted" disabled aria-label="Default select example" name='type' data-validate-field='type'>
  ...
  <option <?php echo ($mod['type']=='Phase')? "selected":''?> value="Phase">Phase</option>
       ...
       <div class='col-md-4'>
        ...
        <select class="form-select text-muted" disabled aria-label="Default select example" name='status' data-validate-field='status'>
  <option selected value=''>Select</option>
  ...
  <option <?php echo ($mod['status']=='Rejected')? "selected":''?> value="Rejected">Rejected</option>
       ...
       <div class='col-md-4'>
        <label class='form-label text-muted fw-bold fs-5'>start date</label>
  <!--start date-->
  <input type = 'text' class = 'datepicker-2 form-control' name='s_date'  value='<?php echo date("m-d-Y", strtotime( $mod['s_date'])); ?>'>

       </div>

       <div class='col-md-4'>
        <label class='form-label text-muted fw-bold fs-5'>end date</label>
<!--end date-->
<input type = 'text' class = 'datepicker-3 form-control' name='e_date' value='<?php echo  date("m-d-Y", strtotime( $mod['e_date'])); ?> '>

       </div>

       <div class='col-md-4 mt-md-0 mt-2'>
       <label class='form-label text-muted fw-bold fs-5 invisible'></label>
      ...
      ajax({
        ...
        if(data=="success"){
            ...
            //    alert("yes");     
                      ...
                      $(".alert").first().html("Schedule Update Successfully");
                      $(".alert").addClass("d-block");
                      setTimeout(function() {
                        $(".alert").removeClass("d-block");
                      $(".alert").addClass("d-none");
                      
                      window.location.replace("add_schedule.php?id="+<?php echo $mod['p_id'];?>);
                      }, 3000);
        }
