...
<div class='row bg-body p-3 h-auto '>
       ...
       <label class='form-label text-muted fw-bold fs-5'>Test Purpose</label>
         ...
         <select name='req' class='form-select text-muted' data-validate-field='req'>
           ...
           <?php if(mysqli_num_rows($require)>0){
             ...
             ?>
             <option value="<?php echo $req['r_id'];?>" <?php echo ($test['r_id']==$req['r_id'])?"selected":"";?>><?php echo $req['name'];?></option>
         <?php  }}?>
         </select>
      ...
      <div class='col-md-3'>
        ...
        <input class='form-control'placeholder='Test Case Name' value="<?php echo $test['name'];?>" name='subject' data-validate-field='subject'>

       </div>

       <div class='col-md-6'>
        <label class='form-label text-muted fw-bold fs-5'>Description</label>
        <input class='form-control'placeholder='Test Case Name'  value="<?php echo $test['description'];?>" name='description' data-validate-field='description'>
  ...
  <option value="<?php echo $asgn['m_id']; ?>"<?php echo($test['assigned']==$asgn['m_id'])?"selected":""?>  ><?php echo $asgn['f_name']; ?></option>
<?php }?>
        ...
        <select name="projects[]" class='skills' multiple="multiple" id="skills">
		                             <?php if (mysqli_num_rows($browser)>0){
                                        while($pro=mysqli_fetch_assoc($browser)){
                                          $query="select * from browser_cross where t_id=".$t_id;
                                          ...
                                          if(mysqli_num_rows($ids)>0){
                                            while($get=mysqli_fetch_assoc($ids)){
                                               $s_id=$get['b_id'];
                                               if($s_id==$pro['b_id']){
                                                 $bool=1;
                                                 break;
                                          ...
                                          ?>
                                                 ...
                                                 <option value="<?php echo $pro['b_id'];?>"<?php echo ($bool==1)?"selected":"";?>><?php echo $pro['name']?></option>
                                        <?php }  }?>
		                        </select>
        ...
        <select name="projects[]" multiple="multiple" class='skills' id="cpu">
		                             <?php if (mysqli_num_rows($browser)>0){
                                        while($pro=mysqli_fetch_assoc($browser)){
                                          ...
                                          $query="select * from cpu_cross where t_id=".$t_id;
                                          $ids=mysqli_query($conn,$query);
                                          $get=NULL;
                                          $s_id=NULL;
                                          $bool=0;
                                          ...
                                          ?>
                                                 ...
                                                 <option value="<?php echo $pro['c_id'];?>" <?php echo($bool==1)?"selected":""?>><?php echo $pro['name']?></option>
                                        <?php }  }?>
		                        </select>
       ...
       ?>
        ...
        <select name="projects[]" multiple="multiple" class='skills' id="os">
		                             <?php if (mysqli_num_rows($browser)>0){
                                        while($pro=mysqli_fetch_assoc($browser)){
                                          $query="select * from operating_system_cross where t_id=".$t_id;
                                          $ids=mysqli_query($conn,$query);
                                          $get=NULL;
                                          $s_id=NULL;
                                          $bool=0;
                                          ...
                                          ?>
                                                 ...
                                                 <option value="<?php echo $pro['o_id'];?>" <?php echo ($bool==1)?"selected":"";?>><?php echo $pro['name']?></option>
                                        <?php }  }?>
		                        </select>
        ...
        <select name="projects[]" multiple="multiple" class='skills' id="database">
		                             <?php if (mysqli_num_rows($browser)>0){
                                        while($pro=mysqli_fetch_assoc($browser)){
                                          ...
                                          $query="select * from storage_cross where t_id=".$t_id;
                                          $ids=mysqli_query($conn,$query);
                                          $get=NULL;
                                          $s_id=NULL;
                                          $bool=0;
                                          ...
                                          ?>
                                                 ...
                                                 <option value="<?php echo $pro['d_id'];?>" <?php echo($bool==1)?"selected":""?>><?php echo $pro['name']?></option>
                                        <?php }  }?>
		                        </select>
       ...
       <div class='col-md-6'>
        ...
        <input type="text" name='s_date' data-validate-field='s_date' class='form-control' value="<?php echo date("Y-m-d ",strtotime($test['due']));;?>" autocomplete='off' id="datepicker">
  ...
  <option value="Pass" <?php echo($test['status']=="Pass")?"selected":""?>>Pass</option>
  <option value="Fail" <?php echo($test['status']=="Fail")?"selected":""?>>Fail</option>
  <option value="Inconclusive" <?php echo($test['status']=="Inconclusive")?"selected":""?>>Inconclusive</option>
  <option value="Error" <?php echo($test['status']=="Error")?"selected":""?>>Error</option>
