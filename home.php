    ...
    <div class="collapse navbar-collapse " id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0 ">
        ...
        <li class="nav-item dropdown d-block d-md-none ">
          ...
          <li><a class="dropdown-item text-light fw-bold active " href="index.php">Assign projects</a></li>
            <li><hr class="dropdown-divider text-light"></li>
            <li><a class="dropdown-item  fw-bold" href="history.php">History</a></li>
            <li><hr class="dropdown-divider text-light"></li>
          </ul>
        </li>
...
<section class=' bg h-100'>
  ...
  <li><a class="dropdown-item text-light fw-bold active " href="index.php">Assign projects</a></li>
            <li><hr class="dropdown-divider text-light"></li>
            <li><a class="dropdown-item text-light fw-bold" href="history.php">History</a></li>
            <li><hr class="dropdown-divider text-light"></li>
...
<?php if(mysqli_num_rows($projects)>0){ 
       ...
       while($fetch=mysqli_fetch_assoc($projects)){
  ?>
