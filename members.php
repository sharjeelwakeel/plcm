...
// }
 ...
 $query="select * from projects where p_id=".$id;
  ...
  $query="select members.m_id,f_name,l_name,s_name,d_name from assign_projects,members,speciality,designation where p_id=".$id." and members.m_id=assign_projects.m_id and speciality=s_id and designation=d_id";
//echo $query;
        ...
        <li class="nav-item dropdown d-block d-md-none ">
          ...
          <!-- <li><a class="dropdown-item text-light fw-bold  " href="home.php">Assign projects</a></li>
            ...
            <li><a class="dropdown-item" href="road_map.php?id=<?php echo $id;?>">Road Map</a></li>         
              ...
              <li><hr class="dropdown-divider text-light"></li>
              <li><a class="dropdown-item text-light fw-bold active" href="members.php?id=<?php echo $id;?>">Members</a></li>         
              <li><hr class="dropdown-divider text-light"></li>
...
<table id="userTable" class=' table table-hover '>
        ...
        <tbody>
           ...
           while($fet=mysqli_fetch_assoc($assign)){?>
           <tr>
             <td><?php echo $fet['m_id'];?></td>
