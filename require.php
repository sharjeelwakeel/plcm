...
//echo $query;
  ...
  $query="select * from requirement,module where requirement.p_id=".$id. " and requirement.mod_id=module.mod_id";
        ...
        <li class="nav-item dropdown d-block d-md-none ">
          ...
          <!-- <li><a class="dropdown-item text-light fw-bold  " href="home.php">Assign projects</a></li>
            ...
            <li><a class="dropdown-item" href="road_map.php?id=<?php echo $id;?>">Road Map</a></li>         
              <li><hr class="dropdown-divider text-light"></li>
              <li><a class="dropdown-item  text-light fw-bold active" href="work_packages.php?id=<?php echo $id;?>">Work Package</a></li>         
              <li><hr class="dropdown-divider text-light"></li>
...
<div class='row bg-body p-3 h-auto '>
          ...
          <div class='col-12'>
          <p class='text-end'>
          <?php   $query="select * from permission_status where m_id=".$m_id." and p_id=12";
...
// exit;
?>
  <a class="btn btn-success <?php echo($cfg['p_id']==12 && $cfg['status']=="no")?"disabled":"" ?> " data-bs-toggle="collapse" href="#collapseExample" role="button" aria-expanded="false" aria-controls="collapseExample">
...
<div class="collapse p-0" id="collapseExample">
  ...
  <form  method="POST" class='js-form module' enctype="multipart/form-data" id="fileUploadForm">
      ...
      <div class='col-md-4'>
        <label class='form-label text-muted fs-5 fw-bold'>Name</label>
        <input class='form-control'placeholder='Name' name='subject' data-validate-field='subject'>

       </div>

       <div class='col-md-4'>
        <label class='form-label text-muted fw-bold fs-5'>Module</label>
        <select class="form-select text-muted" aria-label="Default select example" id="mod_id" name='mod_id' data-validate-field='module'>
  ...
  <?php
    ...
    $module=mysqli_query($conn,$query);
  if(mysqli_num_rows($module)>0){while($fet=mysqli_fetch_assoc($module)){?>
  <option value="<?php echo $fet['mod_id']; ?>"><?php echo $fet['subject']; ?></option>
<?php }}?>
       ...
       <div class='col-md-4'>
        <label class='form-label text-muted fw-bold fs-5'>Artifact Type</label>
...
<table id="userTable" class=' table table-hover '>
        ...
        <tbody>
           ...
           <tr>
             ...
             <td>
             <?php   $query="select * from permission_status where m_id=".$m_id." and p_id=13";
...
// exit;
?>
             <button type="button" class="btn btn-success btn-sm update d-none <?php echo($cfg['p_id']==13 && $cfg['status']=="no")?"disabled":"" ?>"  data-action="update" data-bs-toggle="modal" data-bs-target="#updatemodal" data-id="<?php echo$fet['r_id'];?>" data-name="<?php echo$fet['name'];?>"  data-status="<?php echo$fet['artifact'];?>" data-module="<?php echo$fet['mod_id'];?>" ><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pencil-square" viewBox="0 0 16 16" >
  <path d="M15.502 1.94a.5.5 0 0 1 0 .706L14.459 3.69l-2-2L13.502.646a.5.5 0 0 1 .707 0l1.293 1.293zm-1.75 2.456-2-2L4.939 9.21a.5.5 0 0 0-.121.196l-.805 2.414a.25.25 0 0 0 .316.316l2.414-.805a.5.5 0 0 0 .196-.12l6.813-6.814z"/>
  <path fill-rule="evenodd" d="M1 13.5A1.5 1.5 0 0 0 2.5 15h11a1.5 1.5 0 0 0 1.5-1.5v-6a.5.5 0 0 0-1 0v6a.5.5 0 0 1-.5.5h-11a.5.5 0 0 1-.5-.5v-11a.5.5 0 0 1 .5-.5H9a.5.5 0 0 0 0-1H2.5A1.5 1.5 0 0 0 1 2.5v11z"/>
</svg></button>

<?php   $query="select * from permission_status where m_id=".$m_id." and p_id=14";
...
// exit;
?>
                          <button class="btn btn-success btn-sm delete <?php echo($cfg['p_id']==14 && $cfg['status']=="no")?"disabled":"" ?>" data-bs-toggle="tooltip" data-bs-html="true" title="<em>delete</em>" data-id="<?php echo$fet['r_id'];?>" ><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-archive-fill" viewBox="0 0 16 16">
...
<div class="modal-dialog bg-light">
    ...
    <form  method="POST" class='js-form-update' > 
      ...
      <div class='row justify-content-start '>
      <div class='col-md-4'>
        <label class='form-label text-start text-muted fs-5 fw-bold'>Name</label>
        <input class='form-control'placeholder='Name' name='subject' data-validate-field='subject'>
...
$module=mysqli_query($conn,$query);
if(mysqli_num_rows($module)>0){while($fet=mysqli_fetch_assoc($module)){?>
<option value="<?php echo $fet['mod_id']; ?>" data-name='<?php echo $fet['subject']; ?>'><?php echo $fet['subject']; ?></option>
<?php }}?>
...
formdata.append("status", $(".js-form-update #select").val());
formdata.append("subject",$(".js-form-update input[name=subject]").val());
formdata.append("mod_id",$(".js-form-update select[name=mod_id]").val());


formdata.append("id",id);
    //  alert($(".js-form-update #select").val());
    // alert( $(".js-form-update input[name=subject]").val());
    // alert(id)


      $.ajax({
        url: 'php/update_require.php',
        method: 'POST',
      data:formdata,
      contentType: false, //this is requireded please see answers above
            processData: false,
