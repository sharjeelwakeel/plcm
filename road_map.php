...
$road_map=mysqli_query($conn,$query);
        ...
        <li class="nav-item dropdown d-block d-md-none ">
          ...
          <!-- <li><a class="dropdown-item text-light fw-bold  " href="home.php">Assign projects</a></li>
            ...
            <li><a class="dropdown-item text-light fw-bold active" href="road_map.php?id=<?php echo $id?>">Road Map</a></li>         
              <li><hr class="dropdown-divider text-light"></li>
              <li><a class="dropdown-item " href="work_packages.php?id=<?php echo $id?>">Work Package</a></li>         
              <li><hr class="dropdown-divider text-light"></li>
        ...
        <div class='col-12 text-muted h3 fw-bold'>
          ...
          <div class='row mt-4'>
            <div class='col-12 border border-start-0 border-end-0 border-top-0 border border-success p-0'><span class="bg-success px-5 text-light fw-bold mt-1 d-inline-block">Projects</span></div>
             ...
             <div class='text-success fw-bold border-0 my-4 col-12'><?php echo $pro['p_title'];?>:<span class='text-secondary'><?php   $s_date = date("Y-m-d", strtotime ($pro['issue_date']));
                                                                                                                        $e_date = date("Y-m-d", strtotime ($pro['end_date']));
...
<table id="userTable" class=' table table-hover border-0 '>
        ...
        <tbody>
           <?php 
           if(mysqli_num_rows($road_map)>0){
           while($fet=mysqli_fetch_assoc($road_map)){ if($fet['e_date']!=NULL){?>
...
$endDate = new DateTime($fet['e_date']);
...
echo dateDifference(date("Y-m-d H:i:s"),$fet['e_date']);
