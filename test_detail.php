...
//   exit;
 ...
 $query="select * from projects where p_id=".$id;
  ...
  $query="select * from test_case,members where t_id=".$t_id." and m_id=assigned";
  $test_case=mysqli_query($conn,$query);

  $mod=mysqli_fetch_assoc($test_case);


  


//   $sch=mysqli_fetch_assoc($storage);
...
<div class='row bg-body p-3 h-auto '>
          ...
          <div class='col-12'> 
              <div class='row'>
          <div class='col-12 border border-start-0 border-end-0 border-top-0 border border-success p-0 mt-4'><span class="bg-success px-5 text-light fw-bold mt-1 d-inline-block">Test Case</span></div>

          <div class='col-12 mt-1'> <span class='text-dark fw-bold'>Name:</span><span class='text-secondary fw-bold'><?php echo $mod['name']; ?></span></div>
         
          <div class='col-12 mt-1'> <span class='text-dark fw-bold'>Assigned:</span><span class='text-secondary fw-bold transform-capitilize'><?php echo $mod['f_name']." ".$mod['l_name']; ?></span></div>
          ...
          <div class='col-12 mt-1'> <span class='text-dark fw-bold'>Description:</span><span class='text-secondary fw-bold transform-capitilize'><?php echo $mod['description']; ?></span></div>
          ...
          <div class='col-12 mt-2'> 
              <div class='row'>
          <div class='col-12 border border-start-0 border-end-0 border-top-0 border border-success p-0 mt-4'><span class="bg-success px-5 text-light fw-bold mt-1 d-inline-block">Browser/Devices<span></div>
                 <?php
                 
                 $query="select * from browser_cross,browser where browser_cross.t_id=".$t_id." and browser_cross.b_id=browser.b_id";
               //  echo $query;
                 $storage=mysqli_query($conn,$query);

                 if(mysqli_num_rows($storage)>0){
                     $str=Null;
                     while($str=mysqli_fetch_assoc($storage)) {
               //    echo  $str['name'];
                      ?>
                     

 <div class='col-12 mt-1'><span class='text-secondary fw-bold'><?php echo $str['name']; ?></span></div>
         
                <?php } }
                 else{
                     ?>
                    <div class='col-12 mt-1'> <span class='text-dark fw-bold'></span><span class='text-secondary fw-bold'>-</span></div>
          ...
          <div class='col-12 mt-2'> 
              <div class='row'>
          <div class='col-12 border border-start-0 border-end-0 border-top-0 border border-success p-0 mt-4'><span class="bg-success px-5 text-light fw-bold mt-1 d-inline-block">Database<span></div>
                 <?php
                 
                 $query="select * from storage_cross,storage where storage_cross.t_id=".$t_id." and s_id=d_id";
               //  echo $query;
                 $storage=mysqli_query($conn,$query);
 ...
 <div class='col-12 mt-1'><span class='text-secondary fw-bold'><?php echo $str['name']; ?></span></div>
          ...
          <div class='col-12 mt-2'> 
              <div class='row'>
          <div class='col-12 border border-start-0 border-end-0 border-top-0 border border-success p-0 mt-4'><span class="bg-success px-5 text-light fw-bold mt-1 d-inline-block">Operating System<span></div>
                 <?php
                 
                 $query="select * from operating_system_cross,operating_system where operating_system_cross.t_id=".$t_id." and operating_system_cross.o_id=operating_system.o_id";
               //  echo $query;
                 $storage=mysqli_query($conn,$query);
 ...
 <div class='col-12 mt-1'><span class='text-secondary fw-bold'><?php echo $str['name']; ?></span></div>
          ...
          <div class='col-12 mt-2'> 
              <div class='row'>
          <div class='col-12 border border-start-0 border-end-0 border-top-0 border border-success p-0 mt-4'><span class="bg-success px-5 text-light fw-bold mt-1 d-inline-block">CPU<span></div>
                 <?php
                 
                 $query="select * from cpu_cross,cpu where cpu_cross.t_id=".$t_id." and cpu_cross.c_id=cpu.c_id";
               //  echo $query;
                 $storage=mysqli_query($conn,$query);
