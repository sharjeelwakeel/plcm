...
//echo $query;
  ...
  $query="select * from content where r_id=".$r_id;
// echo  $query;
// exit;
...
if($content['file_path']!=''){
  $g=new DocxConversion($content['file_path']);
...
<!-- 
  ...
  <option value="Heading">Heading</option>
       ...
       <div class='col-md-8'>
        ...
        <input class='form-control'placeholder='description' name='desc' data-validate-field='subject'>
...
<table id="userTable" class=' table table-hover table-borderless '>
        <thead>
            <th>ID</th>
            <th>Name</th>
            <th>Content</th>
        ...
        <tbody >
           ...
           <tr >
             <td ><a href='content.php?id=<?php echo $pro['p_id']?>&&r_id=<?php echo $fet['r_id'];?>' class='text-decoration-none text-dark'><?php echo $fet['c_id'];?></a></td>
             <td><?php echo $fet['status'];?></td>
             <td class='<?php echo($fet['status']=="Heading")?"h4 fw-bold":''?>'><?php echo $fet['description'];?>
            <?php if($fet['file_path']!=NULL){?>
               <div><img src='<?php echo $fet['file_path']?>'></div>
          <?php  }?>
            </td>
             <td>
<?php  if($m_id==$fet['m_id']){?>
    ...
    <ul class="dropdown-menu px-2" aria-labelledby="dropdownMenu2" style="min-width:50px">
        <div class='text-end '>
    <button type="button" class="btn btn-success btn-sm update"  data-action="update" data-bs-toggle="modal" data-bs-target="#updatemodal" data-id="<?php echo$fet['c_id'];?>" data-description="<?php echo$fet['description'];?>"  data-status="<?php echo$fet['status'];?>" ><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pencil-square" viewBox="0 0 16 16" >
  <path d="M15.502 1.94a.5.5 0 0 1 0 .706L14.459 3.69l-2-2L13.502.646a.5.5 0 0 1 .707 0l1.293 1.293zm-1.75 2.456-2-2L4.939 9.21a.5.5 0 0 0-.121.196l-.805 2.414a.25.25 0 0 0 .316.316l2.414-.805a.5.5 0 0 0 .196-.12l6.813-6.814z"/>
  <path fill-rule="evenodd" d="M1 13.5A1.5 1.5 0 0 0 2.5 15h11a1.5 1.5 0 0 0 1.5-1.5v-6a.5.5 0 0 0-1 0v6a.5.5 0 0 1-.5.5h-11a.5.5 0 0 1-.5-.5v-11a.5.5 0 0 1 .5-.5H9a.5.5 0 0 0 0-1H2.5A1.5 1.5 0 0 0 1 2.5v11z"/>
</svg></button>
</div>

<div class='text-end '>                         <button class="btn btn-success btn-sm delete mt-1" data-bs-toggle="tooltip" data-bs-html="true" title="<em>delete</em>" data-id="<?php echo$fet['c_id'];?>" ><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-archive-fill" viewBox="0 0 16 16">
...
var id;
 ...
 // return false;
   ...
   $(".img").fadeIn("slow").append("<img src='"+"admin/web_material/pdf_img.png"+"' class='img-thumbnail' style='width:auto; height:auto'>");
   $(".error").slideUp(); 
  }
   else{
     alert("ok");
