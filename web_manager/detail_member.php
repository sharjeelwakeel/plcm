...
$query="select * from members,designation,speciality where m_id=".$_GET['p_id']." and designation=d_id and speciality=s_id";
$result=mysqli_query($conn,$query);

$query="select * from languages,technology where m_id=".$_GET['p_id']." and l_name=t_id";
...
<?php if(mysqli_num_rows($result)>0){ 
  ...
  <ul class="dropdown-menu" aria-labelledby="dropdownMenu2">
    ...
    <li><button class="dropdown-item" type="button">Delete</button></li>
          ...
          <img src='<?php echo "../admin/".$row['img_path']; ?>' style='width:300px;height:300px' class='rounded-circle mx-auto img-thumbnail'>
