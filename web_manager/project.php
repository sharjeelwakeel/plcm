        ...
        <tbody>
            <?php if(!empty($arr_users)) { ?>
                <?php foreach($arr_users as $user) { ?>
                    ...
                    <td><?php echo $user['p_id']; ?></td>
                                  <td>
                                
<strong class='text-success'><?php echo $user['p_title']; ?></strong></td>
                                  <td><?php echo $user['c_name']; ?></td>
                
                         
                          <td><a class="btn btn-success btn-sm" href="detail_project.php?id=<?php echo $user['p_id'];?>">view</a>
