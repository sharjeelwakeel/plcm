...
<div class="collapse p-0" id="collapseExample">
  ...
  <option value="To be schedule">To be schedule</option>
...
<table id="userTable" class=' table table-hover '>
        ...
        <tbody>
           ...
           <tr>
             <td ><a href='c_detail.php?id=<?php echo $pro['p_id']?>&&mod_id=<?php echo $fet['mod_id'];?>' class='text-decoration-none text-dark'><?php echo $fet['mod_id'];?></a></td>
